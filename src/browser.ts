/**
 * Browser-specific observables and utilities.
 *
 * This module provides specific implementations for interacting with the DOM
 * and other browser APIs.
 *
 * Key exports:
 * - {@link fromDomEvent}: Creates an observable from DOM events (clicks, keys, etc).
 *
 * @module browser
 */
